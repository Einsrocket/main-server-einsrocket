...
const addUser = async (req, res) => {
    ...
    var new_utc = Date.UTC(date.getUTCFullYear(), date.getUTCMonth(), date.getUTCDate(), date.getUTCHours(),  date.getUTCMinutes(), date.getUTCSeconds())

    // utc date for todays date
    var second_new_utc = Date.UTC(date_two.getUTCFullYear(), date_two.getUTCMonth(), date_two.getUTCDate(), date_two.getUTCHours(),  date_two.getUTCMinutes(), date_two.getUTCSeconds())
